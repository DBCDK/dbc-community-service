...
module.exports = function(Flag) {
  ...
  Flag.observe('before save', function afterFlagSave(ctx, next) {
    ...
    const isPostFlag =
      typeof data.postFlagsId !== 'undefined' && data.postFlagsId;
    const isCommentFlag =
      typeof data.commentFlagsId !== 'undefined' && data.commentFlagsId;
    const isGroupFlag =
      typeof data.groupFlagsId !== 'undefined' && data.groupFlagsId;
    const isReviewFlag =
      typeof data.reviewFlagsId !== 'undefined' && data.reviewFlagsId;
